...
public class Lang extends AbstractOkaeriConfigFile {
    ...
    /**
     * Same as {@link #getEntry(String, Object...)} but without any color codes, for text that is rendered by
     * the command framework instead of being sent as a legacy formatted string.
     *
     * @param key  The translation key
     * @param args The arguments to fill in
     * @return The entry without color codes
     */
    public String getPlainEntry(String key, Object... args) {
        return ChatColor.stripColor(BreweryUtil.color(this.getEntry(key, false, args)));
    }

    /**
     * Extracts the plain description of a {@code Help_*} entry.
     * <p>
     * Those entries are written as {@code &6<usage>&9 <description>}, the usage part is generated by the command
     * framework instead, so only the text after the {@code &9} marker is of interest. Color codes are removed as
     * the help screen applies its own colors.
     *
     * @param key The translation key of a {@code Help_*} entry
     * @return The description without the usage part and without color codes, empty if the key is unknown
     */
    public String getCommandDescription(String key) {
        if (mappedEntries == null) {
            mapStrings();
        }
        if (!(mappedEntries.get(key) instanceof String entry)) {
            return "";
        }
        int marker = entry.indexOf("&9");
        String description = marker >= 0 ? entry.substring(marker + 2) : entry;
        return ChatColor.stripColor(BreweryUtil.color(description)).trim();
    }
    ...
    private String errorInvalidNumber;
    @CustomKey("Error_InvalidSyntax")
    private String errorInvalidSyntax;
    ...
    @Comment("Help")
    @CustomKey("Help_Title")
    private String helpTitle;
    @CustomKey("Help_Command")
    private String helpCommand;
    @CustomKey("Help_Description")
    private String helpDescription;
    @CustomKey("Help_NoDescription")
    private String helpNoDescription;
    @CustomKey("Help_Arguments")
    private String helpArguments;
    @CustomKey("Help_Optional")
    private String helpOptional;
    @CustomKey("Help_AvailableCommands")
    private String helpAvailableCommands;
    @CustomKey("Help_ShowingResultsFor")
    private String helpShowingResultsFor;
    @CustomKey("Help_NoResultsFor")
    private String helpNoResultsFor;
    @CustomKey("Help_ClickToShow")
    private String helpClickToShow;
    @CustomKey("Help_PageOutOfRange")
    private String helpPageOutOfRange;
    @CustomKey("Help_ClickNextPage")
    private String helpClickNextPage;
    @CustomKey("Help_ClickPreviousPage")
    private String helpClickPreviousPage;
    @CustomKey("Help_Age")
    ...
    @CustomKey("Help_ReloadAddons")
    private String helpReloadAddons;
    @CustomKey("Help_Seal")
    ...
    @CustomKey("Help_ShowStats")
    private String helpShowStats;
    ...
    @CustomKey("Help_Version")
    private String helpVersion;
    @CustomKey("Help_ItemName")
