...
public class BreweryDistiller {
    ...
    public BreweryDistiller(Block standBlock, int fuel) {
    ...
    public static void distillerClick(InventoryClickEvent event) {
        ...
        BreweryDistiller distiller = trackedDistillers.get(standBlock);
        if (distiller != null) {
        ...
        distiller = new BreweryDistiller(standBlock, fuel);
