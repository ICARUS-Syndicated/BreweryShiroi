...
@Getter
@Setter
public class BreweryRecipe implements Cloneable {
     ...
     */
    public BreweryRecipe(String name, @NotNull PotionColor color) {
     ...
     */
    public BreweryRecipe(String[] names, @NotNull PotionColor color) {
        this.name = names;
        this.color = color;
        difficulty = 5;
    }
    ...
    public static IngredientResult loadIngredientVerbose(String item) {
        ...
        if (ingredParts.length == 2) {
            amount = BreweryUtil.getRandomIntInRange(ingredParts[1]);
            if (amount < 1) {
        ...
        if (pluginItem.length > 1) {
            ...
            if (custom != null) {
                ...
                BreweryCauldronRecipe.acceptedCustom.add(custom);
...
//		}
     ...
     */
    public static List<BreweryRecipe> getConfigRecipes() {
     ...
     * <br>Changes to the main List of all recipes will make the reference to this sublist invalid
     */
    public static List<BreweryRecipe> getAddedRecipes() {
     ...
     */
    public static List<BreweryRecipe> getAllRecipes() {
        return recipes;
    }
     ...
     */
    @Nullable
    public static BreweryRecipe getMatching(String name) {
        BreweryRecipe mainNameRecipe = get(name);
    ...
    @Nullable
    public static BreweryRecipe getById(String id) {
        for (BreweryRecipe recipe : recipes) {
     ...
     */
    @Nullable
    public static BreweryRecipe get(String name) {
        for (BreweryRecipe recipe : recipes) {
    ...
    @Override
    public BreweryRecipe clone() {
        try {
            BreweryRecipe clone = (BreweryRecipe) super.clone();
    ...
    public static class Builder {
        ...
        public Builder(String... names) {
            recipe = new BreweryRecipe(names, PotionColor.WATER);
        }
        ...
        public Builder addEffects(BreweryEffect... effects) {
            Collections.addAll(recipe.effects, effects);
            return this;
        }

        public BreweryRecipe get() {
            if (recipe.name == null) {
