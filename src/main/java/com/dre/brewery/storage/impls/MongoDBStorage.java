...
public class MongoDBStorage extends DataManager {
    ...
    public BreweryPlayer getPlayer(UUID playerUUID) {
        SerializableBreweryPlayer serializableBreweryPlayer = getGeneric(playerUUID, "players", SerializableBreweryPlayer.class);
    ...
    public void saveAllPlayers(Collection<BreweryPlayer> players) {
        List<SerializableBreweryPlayer> serializableBreweryPlayers = players.stream()
            ...
            .toList();
        saveAllGeneric(serializableBreweryPlayers, "players", SerializableBreweryPlayer.class);
    }
